...
public class Exit extends Sprite {	
	...
	public Exit(float _x, float _y, float _height, float _width, int _zBufferIndex, float _creationTimeMilliseconds, DeviceDisplay _display, SpriteSheetManager _spriteSheetManager, String _animationTag, String _tag)  {
